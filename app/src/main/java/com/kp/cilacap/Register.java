...
//    Button btn, btn2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_username = (EditText) findViewById(R.id.et_usernameRegist);
        txt_password = (EditText) findViewById(R.id.et_passwordRegist);
        txt_confirm_password = (EditText) findViewById(R.id.et_correct_password);
